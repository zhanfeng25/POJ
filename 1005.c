 ...
 * beginning of year 1. (Semicircle illustrated in 1005_semicircle.GIF.)
 * 
 * Input:
 * ------
 *
 ...
 * and Y Cartesian coordinates of the land Fred is considering. These will be
 ...
 * Where N is the data set (counting from 1), and Z is the first year
 * (start from 1) this property will be within the semicircle AT THE END OF
 * YEAR Z. Z must be an integer. After the last data set, this should print
 * out “END OF OUTPUT.”
 *
 * Sample Input:
 * -------------
